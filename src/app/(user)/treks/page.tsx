...
export const metadata: Metadata = buildMetadata({
    title: "Arunachal Pradesh Treks",
    description:
        "Every route runs entirely inside Arunachal Pradesh — from a 3-day trek in Tawang to a multi-day expedition to remote frontier regions.",
    path: "/treks",
});
...
const REGIONS: { value: Region | "all"; label: string }[] = [
    ...
    { value: "lower-subansiri", label: "Lower Subansiri (Ziro)" },
    { value: "dibang-valley", label: "Dibang Valley (Anini)" },
];
